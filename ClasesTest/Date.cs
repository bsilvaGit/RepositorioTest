...
namespace ClasesTest
{
    public class Date
    {
        ...
        private int CheckDay(int year, int month, int day)
        {
            ...
            throw new DayException("Día invalido: " + Convert.ToString(day) + ", verifique los datos de entrada.");
        }
        ...
        private int CheckMonth(int month)
        {
            ...
            throw new MonthException("Mes invalido: " + Convert.ToString(month) + ", verifique los datos de entrada.");
        }
    }
}
